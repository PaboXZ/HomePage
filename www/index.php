...
<head>
    ...
    <script src="../js/pages.js" async="defer"></script>
...
<header>
    ...
    <div class="header-container">
        <div class="header-logo"><i class="icon-share"></i>Mose</div>
        <div></div>
        <div class="header-ico"><i class="icon-chart-bar"></i></div>
        <div class="header-ico"><i class="icon-id-card"></i></div>
    </div>
